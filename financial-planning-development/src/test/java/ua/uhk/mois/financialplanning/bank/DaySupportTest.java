...
class DaySupportTest extends AbsTestConfiguration {
    ...
    void getCountOfDaysInLastMonth_Hds_February() {
        log.info("Test of getting days in last month. February in 2021 will be used for testing.");

        // Data preparation
        ZonedDateTime zonedDateTime = createZonedDateTime(2021, 3);
    ...
    void getCountOfDaysInLastMonth_Hds_December() {
        ...
        // Data preparation
        ZonedDateTime zonedDateTime = createZonedDateTime(2021, 1);
